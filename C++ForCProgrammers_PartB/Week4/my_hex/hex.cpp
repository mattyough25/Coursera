...
// checks if placed piece is legal and in bounds
...
// printing a board based on coursera example mostly
...
void Game::choose()
{
   ...
   cout << "Now we need to pick sides. I'll let you pick. (r/b): ";
   cin >> side;
   if(side == 'r' || side == 'R')
   {
      player = Player::RED;
   ...
   else
   {
      ...
      cout << "I guess I'll choose then...I'm player red!" << endl << endl;
      player = Player::BLUE;
      computer = Player::RED;  
   }
   cin.clear();
